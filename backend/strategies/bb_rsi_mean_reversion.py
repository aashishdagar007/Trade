# D:\AASHISH\Projects\trade\backend\strategies\bb_rsi_mean_reversion.py
import math
...
class BBRSIMeanReversion:
    ...
    - Buys when price touches lower BB and RSI < 30 (oversold)
    - Sells when price touches upper BB and RSI > 70 (overbought)
    - Exits when price returns to middle band (20-period SMA)
    """
    def __init__(self, client: BinanceClient, params: Dict[str, Any]):
        ...
        self.quantity = params.get('quantity', 0.001)  # Default trade size
    ...
    def on_market_data(self, symbol: str, data: dict) -> dict:
        ...
        # Calculate RSI
        rsi = self._calculate_rsi(self.prices, self.rsi_length)
